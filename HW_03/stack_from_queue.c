 ...
 * Date: 07/23/18
 * Description: This file contains linked listQueue
 *      struct and a stack struct made from that queue
 *      The queue is a linked list with a link struct
 *      and methods for creating, destroying, adding
 *      links to the back of, removing links from the
 *      front of, accessing the back of, and printing
 *      the linked ListQueue struct.
 *      The linkedListStack struct has two listQueues,
 *      and methods for creating, destroying, popping,
 *      and accessing the top element in the stack.
 *********************************************************************/
 ...
 * It takes a list and a type variable, allocates the memory and adjusts 
...
/*********************************************************************
 * This function creates the linked list stack. It allocates the memory 
 * and calls the initialization function to initialize all of 
 * the values. It then returns the stack.
 *********************************************************************/
...
/*********************************************************************
 * This function returns 1 if the linked list stack is empty 
...
/*********************************************************************
 * This funciton pops a value off of the stack. It does this by moving
 * all values that are currently on the stack to the other queue. 
...
void linkedListStackPop(struct linkedListStack *s) {
	...
	struct link *curr = s->Q1->firstLink->next;
	while(curr != s->Q1->lastLink){
		listQueueAddBack(s->Q2, curr->value);
		curr = curr->next;
...
/*********************************************************************
 * This function returns the value that is at the back of the queue 
 * that is maintaing the values of the stack.
 *********************************************************************/
